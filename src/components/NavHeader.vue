    ...
    <div class="nav-header">
      <div class="container">
        ...
        <div class="header-menu">
          <div
            class="item-menu"
            v-for="(categoryItem, index) in headerItemList"
            :key="index"
          >
            ...
            <div class="children">
              <ul>
                <li
                  class="product"
                  v-for="(item, index) in categoryItem.products"
                  :key="index"
                >
          ...
          <div class="item-menu">
            <a href="https://www.xiaomi.cn/" target="_blank">社区</a>
          </div>
        </div>
  ...
  methods: {
    getHeaderItemList() {
      this.axios
        .get("/top-category")
        .then((res) => {
          this.headerItemList = res;
        })
        .catch((error) => {
          window.console.error("获取header栏产品列表失败:", error);
        });
    },
    login() {
